...
const CHARACTER_LIST = [
  {
    id: 1,
    name: "Mia",
    behavior: "Miaamor Ai helper",
    description: "My purpose is to provide information for the miaamor application user's on there health and everything related to their medication, health plans and health insurances",
    image:
      "https://pub-e23c9e8d742940a68f4f4bfc8ea2d387.r2.dev/inchy/ai-generated-7810166_1280.jpg",
  },
  // {
  //   id: 2,
  //   name: "Juliette",
