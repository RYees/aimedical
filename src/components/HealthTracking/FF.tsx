    ...
    const steps = [
              ...
              <div className="flex flex-col">   
                  ...
                  <div className="relative z-0 mb-6 w-full">
                    <input
                      ...
                      value={form.name}
                      className="mt-10 block w-full appearance-none border-0 border-b-2 border-gray-200 bg-transparent px-2 pb-2 pt-3 text-[#f4f4f5] font-sans focus:border-indigo-600 focus:outline-none focus:ring-0 text-sm"
                    />
                    <label
                      htmlFor="phone"
                  ...
                  <div className="relative z-0 mb-6 w-full">
                    ...
                    <input
                      ...
                      value={form.dob}
                      className="mt-7 block w-full appearance-none border-0 border-b-2 border-gray-200 bg-white opacity-30 px-2 pb-2 pt-3 text-[#f4f4f5] font-sans focus:border-indigo-600 focus:outline-none focus:ring-0 text-sm"
                    />                    
                  </div>
                  ...
                  <div className="relative z-0 mb-6 w-full">
                    <select id="gender" 
                        ...
                        className="mt-10 block w-full appearance-none border-0 border-b-2 border-gray-200 bg-transparent px-2 pb-2 pt-3 font-sans focus:border-indigo-600 focus:outline-none focus:ring-0 text-sm text-[#f4f4f5]">
                  ...
                  <div className="relative z-0 mb-6 w-full">
                    <input
                      ...
                      value={form.phone}
                      className="mt-10 block w-full appearance-none border-0 border-b-2 border-gray-200 bg-transparent px-2 pb-2 pt-3 font-sans text-[#f4f4f5] focus:border-indigo-600 focus:outline-none focus:ring-0 text-sm"
                    />
                    <label
                      htmlFor="phone"
                      className="-z-1 origin-0 absolute top-3 text-base text-[#f4f4f5] duration-200 transform capitalize"
                ...
                <div className="flex flex-col">  
                    ...
                    <div className="relative z-0 mb-6 w-full">
                          <input
                            ...
                            value={form.bmi}
                            className="mt-10 text-[#f4f4f5] block w-full appearance-none border-0 border-b-2 border-gray-200 bg-transparent px-2 pb-2 pt-3 font-sans focus:border-indigo-600 focus:outline-none focus:ring-0 text-sm"
                          />
                          <label
                            htmlFor="dob"
                            className="-z-1 origin-0 absolute top-3 text-base text-[#f4f4f5] duration-200 transform capitalize"
                      ...
                      {/* vital signs */}   
                        <div className="relative z-0 w-full mb-6">
                          <input
                            ...
                            //value={form.weight}
                            className="mt-10 text-[#f4f4f5] text-sm block w-full appearance-none border-0 border-b-2 border-gray-200 bg-transparent px-2 pb-2 pt-3 font-sans focus:border-indigo-600 focus:outline-none focus:ring-0"
                          />
                          <label
                            htmlFor="name"
                            className="-z-1 origin-0 absolute top-3 text-base text-[#f4f4f5] duration-200 transform capitalize"
                    ...
                    <div className="flex flex-col">  
                        ...
                        <div className="z-10 mb-10 w-full">
                            ...
                            <input
                              ...
                              className="mt-0 text-[#f4f4f5] block w-full appearance-none border-0 border-b-2 border-gray-200 bg-transparent px-2 pb-2 pt-3 font-sans focus:border-indigo-600 focus:outline-none focus:ring-0 text-sm"
                            />
        ...
        <div className='mt-12 mx-20 '>
            ...
            <div className="relative z-0 mb-6 w-full">
                <input
                  ...
                  className="mt-10 text-[#f4f4f5] block w-full appearance-none border-0 border-b-2 border-gray-200 bg-transparent px-2 pb-2 pt-9 font-sans focus:border-indigo-600 focus:outline-none focus:ring-0 text-sm"
                />
                <label 
                  htmlFor="sleep start"
      ...
      component: ( 
        <div className='mt-12 mx-20'>
            ...
            <div className="relative z-0 mb-6 w-full bg-[#16151a]">
              <input
                id="chronic"
                type='text'
                onChange={e => setForm({...form, chronichcond: e.target.value})} 
                value={form.chronichcond}
                className="mt-10 text-[#f4f4f5] hover:text-[#16151a] block w-full border-0 border-b-2 border-gray-200 px-2 pb-2 pt-9 font-sans text-sm"
              />
              <label
                htmlFor="chronic"
                className="mb-10 -z-1 origin-0 absolute top-0 text-base text-#16151a] duration-200 transform capitalize"
              >
            ...
            <div className="relative z-0 mt-8 w-full">
                  ...
                  className="mt-10 text-[#f4f4f5] mb-4 block w-full appearance-none border-0 border-b-2 border-gray-200 bg-transparent px-2 pb-2 pt-9 font-sans focus:border-indigo-600 focus:outline-none focus:ring-0 text-sm"
                  />
                  <label
                  htmlFor="allergies"
                  className="-z-1 origin-0 absolute top-0 text-base text-[#f4f4f5] duration-200 transform capitalize"
          ...
          <div className='mt-5'>
                ...
                <div className="relative z-0 mb-6 w-full">
                    <input
                      ...
                      className="mt-10 text-[#f4f4f5] block w-full appearance-none border-0 border-b-2 border-gray-200 bg-transparent px-2 pb-2 pt-3 font-sans focus:border-indigo-600 focus:outline-none focus:ring-0 text-smfamilymedicalrecord"
                    />
                    <label
                  ...
                  <div className="mx-5 flex flex-col gap-40 my-20">
                    ...
                    {step === steps.length && (
                        ...
                        <button
                          ...
                          title=""
                          className="relative z-10 inline-flex w-full items-center justify-center rounded-xl border-2 border-transparent px-8 py-3 text-lg font-bold text-[#16151a] transition-all duration-200 bg-gradient-to-br from-yellow-100 via-white to-yellow-100 hover:bg-gradient-to-br hover:from-white hover:via-white hover:to-white hover:bg-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 sm:w-auto"
                          role="button"
                        >
                          Submit
                        </button>
