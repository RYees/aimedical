  ...
  testimonials = [
    {
      ...
      quote:
        "MiaAmor has become my digital best friend, always there to listen and make me smile.",
      name: "Jane, 75",
      role: "Acme LTD",
    },
    {
      ...
      quote:
        "I feel less lonely and more engaged with life, all thanks to my wonderful AI companion from MiaAmor.",
      name: " John, 80",
      role: "Malika Inc.",
    },
    // {
        ...
        {testimonials.map((testimonial, index) => (
          <button
            ...
            className={`m-1.5 inline-flex justify-center whitespace-nowrap rounded-full px-3 py-1.5 text-xs shadow-sm transition-colors duration-150 focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-300 dark:focus-visible:ring-slate-600 ${
              active === index
                ? "bg-gradient-to-r from-orange-400 via-fuchsia-500 to-pink-500 text-white shadow-indigo-950/10"
