...
// async function chatWithOpenai(text:any, context:any) {
...
// function getObjectByName(name:any) {
//   return CHARACTER_LIST.find((character) => character.name === name);
// }

// const bots = new TelegramAPI(token, { polling: true });
// const chats = {};
...
//   function chat(selectedCharacter:any) {
//     bot.on("message", async (msg:any) => {
//       const text = msg.text;
//       const chatId = msg.chat.id;
...
//     bot.sendMessage(chatId, (selectedCharacter as any)?.message);
//     bot.sendPhoto(chatId, (selectedCharacter as any)?.image);
//   });
// }
